                ...
                <div className="bg-black/80 backdrop-blur-xl p-6 md:p-12 flex flex-col justify-between border-b lg:border-b-0 lg:border-r border-white/5">
                    <div data-aos="fade-right">
                        <div className="flex items-center gap-4 mb-6">
                            ...
                            <h5 className="text-[#bd8b31] text-[10px] md:text-sm font-black uppercase tracking-[0.4em]">{t('contact.getInTouch', 'Get in Touch')}</h5>
                        </div>
                        ...
                        <div className="space-y-6 md:space-y-8 mt-8 md:mt-12">
                            ...
                            >
                                ...
                                <div>
                                    <p className="text-gray-400 text-[10px] uppercase font-bold tracking-widest">{t('contact.whatsapp', 'Whatsapp')}</p>
                            ...
                            <div className="flex items-start gap-4 group">
                                ...
                                <div className="min-w-0 flex-1">
                                    <p className="text-gray-400 text-[10px] uppercase font-bold tracking-widest">{t('contact.emailSupport', 'Email Support')}</p>
                    ...
                    <form onSubmit={sendMessage} className="space-y-5 md:space-y-6" data-aos="fade-left">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6">
                            <div className="flex flex-col space-y-2">
                                <label className="text-[#bd8b31] text-[10px] font-black uppercase tracking-widest">{t('contact.fullName', 'Full Name')}</label>
                                <input
                                    required
                                    value={name}
                                    ...
                                    type="text" placeholder={t('contact.namePlaceholder', 'John Doe')}
                                />
                            </div>
                            <div className="flex flex-col space-y-2">
                                <label className="text-[#bd8b31] text-[10px] font-black uppercase tracking-widest">{t('contact.emailAddress', 'Email Address')}</label>
                                <input
                                    required
                                    value={email}
                        ...
                        <div className="flex flex-col space-y-2">
                            <label className="text-[#bd8b31] text-[10px] font-black uppercase tracking-widest">{t('contact.yourMessage', 'Your Message')}</label>
                            <textarea
                                required
                                rows="4"
                                value={message}
                        ...
                        <div className={done ? "flex justify-center bg-green-600/20 border border-green-600 text-green-500 px-5 py-3 rounded-xl transition-opacity duration-500" : "hidden"}>
                            <h5 className="font-bold text-xs uppercase tracking-widest text-center">{t('contact.thankYou', "Thanks, we'll get back to you!")}</h5>
                        </div>
                    </form>
                </div>
            </div>
